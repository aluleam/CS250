...
// Pointers for ID and cost arrays
    ...
    do
    {
        ...
        //If it's something other than y or Y then there was an invalid input
    ...
    // Deallocate memory once we are done
    delete[] id;
    delete[] cost;
...
int read_first_number(void)
{
    ...
    myfile.open("/Users/makingaberto/Library/Developer/Xcode/DerivedData/Homework1-cwbihvddykbeeebbrmljtotutmpk/Build/Products/Debug/cost.txt"); //Open the file
...
void readData(int* &ID, double* &cost, int size)
{
    ...
    int count = 0;
    ifstream myFile("/Users/makingaberto/Library/Developer/Xcode/DerivedData/Homework1-cwbihvddykbeeebbrmljtotutmpk/Build/Products/Debug/cost.txt");// open an existing file
